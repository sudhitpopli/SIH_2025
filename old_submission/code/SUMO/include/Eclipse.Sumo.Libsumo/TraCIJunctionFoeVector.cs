...
public class TraCIJunctionFoeVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<TraCIJunctionFoe>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          libsumoPINVOKE.delete_TraCIJunctionFoeVector(swigCPtr);
        }
  ...
  public TraCIJunctionFoeVector() : this(libsumoPINVOKE.new_TraCIJunctionFoeVector__SWIG_0(), true) {
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public TraCIJunctionFoeVector(TraCIJunctionFoeVector other) : this(libsumoPINVOKE.new_TraCIJunctionFoeVector__SWIG_1(TraCIJunctionFoeVector.getCPtr(other)), true) {
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Clear() {
    libsumoPINVOKE.TraCIJunctionFoeVector_Clear(swigCPtr);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Add(TraCIJunctionFoe x) {
    libsumoPINVOKE.TraCIJunctionFoeVector_Add(swigCPtr, TraCIJunctionFoe.getCPtr(x));
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = libsumoPINVOKE.TraCIJunctionFoeVector_size(swigCPtr);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private bool empty() {
    bool ret = libsumoPINVOKE.TraCIJunctionFoeVector_empty(swigCPtr);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private uint capacity() {
    uint ret = libsumoPINVOKE.TraCIJunctionFoeVector_capacity(swigCPtr);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void reserve(uint n) {
    libsumoPINVOKE.TraCIJunctionFoeVector_reserve(swigCPtr, n);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public TraCIJunctionFoeVector(int capacity) : this(libsumoPINVOKE.new_TraCIJunctionFoeVector__SWIG_2(capacity), true) {
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  private TraCIJunctionFoe getitemcopy(int index) {
    TraCIJunctionFoe ret = new TraCIJunctionFoe(libsumoPINVOKE.TraCIJunctionFoeVector_getitemcopy(swigCPtr, index), true);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  private void setitem(int index, TraCIJunctionFoe val) {
    libsumoPINVOKE.TraCIJunctionFoeVector_setitem(swigCPtr, index, TraCIJunctionFoe.getCPtr(val));
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(TraCIJunctionFoeVector values) {
    libsumoPINVOKE.TraCIJunctionFoeVector_AddRange(swigCPtr, TraCIJunctionFoeVector.getCPtr(values));
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public TraCIJunctionFoeVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = libsumoPINVOKE.TraCIJunctionFoeVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, TraCIJunctionFoe x) {
    libsumoPINVOKE.TraCIJunctionFoeVector_Insert(swigCPtr, index, TraCIJunctionFoe.getCPtr(x));
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, TraCIJunctionFoeVector values) {
    libsumoPINVOKE.TraCIJunctionFoeVector_InsertRange(swigCPtr, index, TraCIJunctionFoeVector.getCPtr(values));
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    libsumoPINVOKE.TraCIJunctionFoeVector_RemoveAt(swigCPtr, index);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    libsumoPINVOKE.TraCIJunctionFoeVector_RemoveRange(swigCPtr, index, count);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public static TraCIJunctionFoeVector Repeat(TraCIJunctionFoe value, int count) {
    global::System.IntPtr cPtr = libsumoPINVOKE.TraCIJunctionFoeVector_Repeat(TraCIJunctionFoe.getCPtr(value), count);
    TraCIJunctionFoeVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new TraCIJunctionFoeVector(cPtr, true);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    libsumoPINVOKE.TraCIJunctionFoeVector_Reverse__SWIG_0(swigCPtr);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Reverse(int index, int count) {
    libsumoPINVOKE.TraCIJunctionFoeVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, TraCIJunctionFoeVector values) {
    libsumoPINVOKE.TraCIJunctionFoeVector_SetRange(swigCPtr, index, TraCIJunctionFoeVector.getCPtr(values));
    if (libsumoPINVOKE.SWIGPendingException.Pending) throw libsumoPINVOKE.SWIGPendingException.Retrieve();
  }
