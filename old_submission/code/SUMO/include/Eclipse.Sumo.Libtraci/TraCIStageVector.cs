...
public class TraCIStageVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<TraCIStage>
 {
  ...
  internal static global::System.Runtime.InteropServices.HandleRef swigRelease(TraCIStageVector obj) {
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          libtraciPINVOKE.delete_TraCIStageVector(swigCPtr);
        }
  ...
  public TraCIStageVector() : this(libtraciPINVOKE.new_TraCIStageVector__SWIG_0(), true) {
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public TraCIStageVector(TraCIStageVector other) : this(libtraciPINVOKE.new_TraCIStageVector__SWIG_1(TraCIStageVector.getCPtr(other)), true) {
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Clear() {
    libtraciPINVOKE.TraCIStageVector_Clear(swigCPtr);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Add(TraCIStage x) {
    libtraciPINVOKE.TraCIStageVector_Add(swigCPtr, TraCIStage.getCPtr(x));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = libtraciPINVOKE.TraCIStageVector_size(swigCPtr);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private bool empty() {
    bool ret = libtraciPINVOKE.TraCIStageVector_empty(swigCPtr);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private uint capacity() {
    uint ret = libtraciPINVOKE.TraCIStageVector_capacity(swigCPtr);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void reserve(uint n) {
    libtraciPINVOKE.TraCIStageVector_reserve(swigCPtr, n);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public TraCIStageVector(int capacity) : this(libtraciPINVOKE.new_TraCIStageVector__SWIG_2(capacity), true) {
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  private TraCIStage getitemcopy(int index) {
    TraCIStage ret = new TraCIStage(libtraciPINVOKE.TraCIStageVector_getitemcopy(swigCPtr, index), true);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private TraCIStage getitem(int index) {
    TraCIStage ret = new TraCIStage(libtraciPINVOKE.TraCIStageVector_getitem(swigCPtr, index), true);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, TraCIStage val) {
    libtraciPINVOKE.TraCIStageVector_setitem(swigCPtr, index, TraCIStage.getCPtr(val));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(TraCIStageVector values) {
    libtraciPINVOKE.TraCIStageVector_AddRange(swigCPtr, TraCIStageVector.getCPtr(values));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public TraCIStageVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = libtraciPINVOKE.TraCIStageVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, TraCIStage x) {
    libtraciPINVOKE.TraCIStageVector_Insert(swigCPtr, index, TraCIStage.getCPtr(x));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, TraCIStageVector values) {
    libtraciPINVOKE.TraCIStageVector_InsertRange(swigCPtr, index, TraCIStageVector.getCPtr(values));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    libtraciPINVOKE.TraCIStageVector_RemoveAt(swigCPtr, index);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    libtraciPINVOKE.TraCIStageVector_RemoveRange(swigCPtr, index, count);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public static TraCIStageVector Repeat(TraCIStage value, int count) {
    global::System.IntPtr cPtr = libtraciPINVOKE.TraCIStageVector_Repeat(TraCIStage.getCPtr(value), count);
    TraCIStageVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new TraCIStageVector(cPtr, true);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    libtraciPINVOKE.TraCIStageVector_Reverse__SWIG_0(swigCPtr);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Reverse(int index, int count) {
    libtraciPINVOKE.TraCIStageVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, TraCIStageVector values) {
    libtraciPINVOKE.TraCIStageVector_SetRange(swigCPtr, index, TraCIStageVector.getCPtr(values));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }
