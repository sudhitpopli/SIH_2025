...
public class TraCISignalConstraintVector : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<TraCISignalConstraint>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          libtraciPINVOKE.delete_TraCISignalConstraintVector(swigCPtr);
        }
  ...
  public TraCISignalConstraintVector() : this(libtraciPINVOKE.new_TraCISignalConstraintVector__SWIG_0(), true) {
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public TraCISignalConstraintVector(TraCISignalConstraintVector other) : this(libtraciPINVOKE.new_TraCISignalConstraintVector__SWIG_1(TraCISignalConstraintVector.getCPtr(other)), true) {
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Clear() {
    libtraciPINVOKE.TraCISignalConstraintVector_Clear(swigCPtr);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Add(TraCISignalConstraint x) {
    libtraciPINVOKE.TraCISignalConstraintVector_Add(swigCPtr, TraCISignalConstraint.getCPtr(x));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = libtraciPINVOKE.TraCISignalConstraintVector_size(swigCPtr);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private bool empty() {
    bool ret = libtraciPINVOKE.TraCISignalConstraintVector_empty(swigCPtr);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private uint capacity() {
    uint ret = libtraciPINVOKE.TraCISignalConstraintVector_capacity(swigCPtr);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void reserve(uint n) {
    libtraciPINVOKE.TraCISignalConstraintVector_reserve(swigCPtr, n);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public TraCISignalConstraintVector(int capacity) : this(libtraciPINVOKE.new_TraCISignalConstraintVector__SWIG_2(capacity), true) {
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  private TraCISignalConstraint getitemcopy(int index) {
    TraCISignalConstraint ret = new TraCISignalConstraint(libtraciPINVOKE.TraCISignalConstraintVector_getitemcopy(swigCPtr, index), true);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private TraCISignalConstraint getitem(int index) {
    TraCISignalConstraint ret = new TraCISignalConstraint(libtraciPINVOKE.TraCISignalConstraintVector_getitem(swigCPtr, index), true);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(int index, TraCISignalConstraint val) {
    libtraciPINVOKE.TraCISignalConstraintVector_setitem(swigCPtr, index, TraCISignalConstraint.getCPtr(val));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void AddRange(TraCISignalConstraintVector values) {
    libtraciPINVOKE.TraCISignalConstraintVector_AddRange(swigCPtr, TraCISignalConstraintVector.getCPtr(values));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public TraCISignalConstraintVector GetRange(int index, int count) {
    global::System.IntPtr cPtr = libtraciPINVOKE.TraCISignalConstraintVector_GetRange(swigCPtr, index, count);
  ...
  public void Insert(int index, TraCISignalConstraint x) {
    libtraciPINVOKE.TraCISignalConstraintVector_Insert(swigCPtr, index, TraCISignalConstraint.getCPtr(x));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void InsertRange(int index, TraCISignalConstraintVector values) {
    libtraciPINVOKE.TraCISignalConstraintVector_InsertRange(swigCPtr, index, TraCISignalConstraintVector.getCPtr(values));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveAt(int index) {
    libtraciPINVOKE.TraCISignalConstraintVector_RemoveAt(swigCPtr, index);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void RemoveRange(int index, int count) {
    libtraciPINVOKE.TraCISignalConstraintVector_RemoveRange(swigCPtr, index, count);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public static TraCISignalConstraintVector Repeat(TraCISignalConstraint value, int count) {
    global::System.IntPtr cPtr = libtraciPINVOKE.TraCISignalConstraintVector_Repeat(TraCISignalConstraint.getCPtr(value), count);
    TraCISignalConstraintVector ret = (cPtr == global::System.IntPtr.Zero) ? null : new TraCISignalConstraintVector(cPtr, true);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
  ...
  public void Reverse() {
    libtraciPINVOKE.TraCISignalConstraintVector_Reverse__SWIG_0(swigCPtr);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void Reverse(int index, int count) {
    libtraciPINVOKE.TraCISignalConstraintVector_Reverse__SWIG_1(swigCPtr, index, count);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public void SetRange(int index, TraCISignalConstraintVector values) {
    libtraciPINVOKE.TraCISignalConstraintVector_SetRange(swigCPtr, index, TraCISignalConstraintVector.getCPtr(values));
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }
