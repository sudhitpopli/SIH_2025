...
public class StringStringMap : global::System.IDisposable 
    , global::System.Collections.Generic.IDictionary<string, string>
 {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          libtraciPINVOKE.delete_StringStringMap(swigCPtr);
        }
  ...
  public StringStringMap() : this(libtraciPINVOKE.new_StringStringMap__SWIG_0(), true) {
  }

  public StringStringMap(StringStringMap other) : this(libtraciPINVOKE.new_StringStringMap__SWIG_1(StringStringMap.getCPtr(other)), true) {
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  private uint size() {
    uint ret = libtraciPINVOKE.StringStringMap_size(swigCPtr);
    return ret;
  }

  private bool empty() {
    bool ret = libtraciPINVOKE.StringStringMap_empty(swigCPtr);
    return ret;
  }

  public void Clear() {
    libtraciPINVOKE.StringStringMap_Clear(swigCPtr);
  }

  private string getitem(string key) {
    string ret = libtraciPINVOKE.StringStringMap_getitem(swigCPtr, key);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private void setitem(string key, string x) {
    libtraciPINVOKE.StringStringMap_setitem(swigCPtr, key, x);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool ContainsKey(string key) {
    bool ret = libtraciPINVOKE.StringStringMap_ContainsKey(swigCPtr, key);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  public void Add(string key, string value) {
    libtraciPINVOKE.StringStringMap_Add(swigCPtr, key, value);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
  }

  public bool Remove(string key) {
    bool ret = libtraciPINVOKE.StringStringMap_Remove(swigCPtr, key);
    if (libtraciPINVOKE.SWIGPendingException.Pending) throw libtraciPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }

  private global::System.IntPtr create_iterator_begin() {
    global::System.IntPtr ret = libtraciPINVOKE.StringStringMap_create_iterator_begin(swigCPtr);
    return ret;
  }

  private string get_next_key(global::System.IntPtr swigiterator) {
    string ret = libtraciPINVOKE.StringStringMap_get_next_key(swigCPtr, swigiterator);
    return ret;
  }

  private void destroy_iterator(global::System.IntPtr swigiterator) {
    libtraciPINVOKE.StringStringMap_destroy_iterator(swigCPtr, swigiterator);
  }
